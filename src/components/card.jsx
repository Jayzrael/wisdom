...
const CardBox = ({ title, description }) => {
  return (
    <div>
      <Card className="mt-6 w-72 py-3 max-lg:w-full h-full bg-black backdrop-filter backdrop-blur-sm bg-opacity-10 border border-gray-100 px-3 shadow-xl transform transition-transform duration-300 hover:scale-105">
